...
"MSWin32\-x64\-multi\-thread-10\.0\.26100\.32522" or
	die "Errno architecture (MSWin32\-x64\-multi\-thread-10\.0\.26100\.32522) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
